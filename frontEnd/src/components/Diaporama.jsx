...
function Diaporama() {
  return (
    ...
    >
      <SwiperSlide>
        <img src={img} className="img-diaporama" />
      </SwiperSlide>
      <SwiperSlide>
        <img src={img2} className="img-diaporama" />
      </SwiperSlide>
      <SwiperSlide>
        <img src={img3} className="img-diaporama" />
      </SwiperSlide>
      <SwiperSlide>
        <img src={img4} className="img-diaporama" />
      </SwiperSlide>
      <SwiperSlide>
        <img src={img5} className="img-diaporama" />
      </SwiperSlide>
      <SwiperSlide>
        <img src={img6} className="img-diaporama" />
      </SwiperSlide>
      <SwiperSlide>
        <img src={img7} className="img-diaporama" />
      </SwiperSlide>
      <SwiperSlide>
        <img src={img8} className="img-diaporama" />
      </SwiperSlide>
      <SwiperSlide>
        <img src={img9} className="img-diaporama" />
      </SwiperSlide>
    </Swiper>
  );
}
