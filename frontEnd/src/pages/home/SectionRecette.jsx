      ...
      <div className="flex md-flex-col-reverse justify-between items-center gap-12">
        <div className="md-w-half px-4 sd-w-full">
          <img
            ...
            alt="banner"
            className="cover rounded-2xl shadow-lg w-150 md-w-full "
          />
        </div>
        <div className="md-w-half px-4 sd-w-full">
          ...
          <div className="flex gap-4 flex-wrap">
            ...
            <div className="space-0 mb-8">
              <h5 className="text-lg font-semibold">
                Avis de nos petits chefs
              </h5>
              <div className="flex items-center gap-2">
                <FontAwesomeIcon
                  icon={faStar}
                  className="hover-scale-110 transition duration-300 text-yellow"
                />
                <span className="font-medium">4.6</span>{" "}
                <span className="text-secondary">(125 avis)</span>
              </div>
            </div>
          </div>
