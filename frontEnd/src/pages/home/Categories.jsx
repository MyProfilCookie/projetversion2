    ...
    <div className='section-container py-16 mb-20'>
      ...
      <div className='gap-4 items-center mt-12 mobile-grid '>
        {Category.map((category) => (
          <Link key={category.id} to={category.path} className='shadow-lg rounded-md py-6 w-112 media-w-96 media-w-64 bg-white rounded-md mx-auto text-center cursor-pointer mb-10'>
